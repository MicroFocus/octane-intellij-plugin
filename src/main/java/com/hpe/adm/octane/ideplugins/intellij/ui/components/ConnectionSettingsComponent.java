...
public class ConnectionSettingsComponent implements HasComponent {
    ...
    private static final String EMPTY_SERVER_URL_TEXT = "Copy paste your OpenText Core Software Delivery Platform URL from the browser here...";
    private static final String EMPTY_SHAREDSPACE_WORKSPACE_URL_TEXT = "Retrieved from server URL";

    private static final String userPassAuthInfoText = "Log into OpenText&trade; Core Software Delivery Platform directly with your user name and password, in non-SSO environments. " + System.lineSeparator() +
            "This method saves your login credentials between sessions, so you do not have to re-enter them.";

    private static final String browserAuthInfoText = "Log into OpenText&trade; Core Software Delivery Platform using a browser. " + System.lineSeparator() +
