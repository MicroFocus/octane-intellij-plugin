...
public class DetailsViewDefaultFields {
    ...
    public static final String FIELD_QAOWNER_UDF = "qa_owner_udf";
    public static final String FIELD_OWNER = "owner";
    public static final String FIELD_BLOCKED = "blocked";
    public static final String FIELD_BLOCKEDBY = "blocked_reason";
    ...
    public static final String FIELD_FEEDBACKTYPE = "feedback_type_udf";
