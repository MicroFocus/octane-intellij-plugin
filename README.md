...
## IntelliJ IDEA IDE Integration for OpenText™ Core Software Delivery Platform
...
Connection to the server is done using the REST SDK for OpenText™ Core Software Delivery Platform, see: <br>
